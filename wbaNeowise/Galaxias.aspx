<%@ Page Title="" Language="C#" MasterPageFile="~/PGMestre.Master" AutoEventWireup="true" CodeBehind="Galaxias.aspx.cs" Inherits="wbaNeowise.Galaxias" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Galaxias</h2>
        ...
        />
        <p class="figure__caption">Existem três tipos de galáxias: elípticas, espirais e irregulares. A nossa Galáxia é a Via Láctea, que tem formato de espiral e está situada no conglomerado denominado Grupo Local, onde também está localizada Andrômeda.

A distância estimada entre as duas é de 2,3 bilhões de anos-luz de distância. Existem pelo menos 100 milhões de galáxias no Universo de todos os tamanhos, formas e cores. O Sol é apenas uma das 100 milhões de estrelas da Via Láctea, com a possibilidade de cada uma delas ser orbitada por planetas.</p>
    </div>
...
As galáxias espirais têm diâmetros que variam de 20 mil anos-luz até mais de 100 mil anos-luz. Estima-se que suas massas variam de 10 bilhões até 10 trilhões de vezes a massa do Sol. A Via-láctea, onde se localiza o sistema solar, é uma galáxia espiral grande e massiva.</p>
    </div>

    <div class="figure">
        <asp:Image ID="Image4" runat="server"
            ImageUrl="~/SlidesShow/g4.jpg"
            CssClass="figure__image"
        />
        <p class="figure__caption">Galáxias irregulares são um tipo de galáxia que apresentam uma estrutura morfológica desordenada ou caótica, ou seja, não possuem formas elípticas ou espirais, mas sim forma indefinida. Geralmente esse tipo de galáxia tem uma grande quantidade de estrelas recém-nascidas e continuam a proliferar novas estrelas estando sempre em intensa atividade.
